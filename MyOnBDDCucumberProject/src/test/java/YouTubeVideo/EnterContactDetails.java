...
WebDriver driver;
	...
	@Then("^user enters \"(.*)\" and \"(.*)\" With Examples KeywordTwo$")
	...
	//Regular Expresstion :
			//1) \"(.*)\"
			//2) \"([^\"]*)\"
	@Then ("^user enters the \"(.*)\" and \"(.*)\" and \"(.*)\" With Examples KeywordTwo$")
	public void user_enter_username_and_password_CompanyName (String firstname, String lastname, String companyname) {
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		driver.findElement(By.xpath("//input[@name='first_name']")).sendKeys(firstname);
		driver.findElement(By.xpath("//input[@name='last_name']")).sendKeys(lastname);
		driver.findElement(By.xpath("//div[@name='company']")).sendKeys(companyname);
